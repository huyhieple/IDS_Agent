...
import logging
import json
# from google.generativeai import GenerativeModel # Vẫn bỏ cho phiên bản khởi tạo không LLM
from sentence_transformers import SentenceTransformer
import os
# from dotenv import load_dotenv # Vẫn bỏ cho phiên bản khởi tạo không LLM
import numpy as np
...
class Aggregation_ChromaDB:
    def __init__(self, collection_name="iot_attacks", model_name="all-MiniLM-L6-v2", db_path=AGGREGATION_DB_PATH): # Thêm db_path
        ...
        try:
            # <<<< SỬA Ở ĐÂY: Sử dụng PersistentClient >>>>
        ...
        # self.llm = GenerativeModel("gemini-1.5-flash") # Vẫn bỏ cho phiên bản khởi tạo

    # ... (các phương thức _get_text_label_from_value, summarize_documents_placeholder, 
    #      và aggregate_results giữ nguyên logic bên trong,
    #      chỉ cần đảm bảo self.collection và self.encoder được khởi tạo đúng) ...
